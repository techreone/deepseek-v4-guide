  ...
  steps: [
    {
      ...
      description:
        "DeepSeek V4 Flash is DeepSeek's fast, efficient, and economical tier of the V4 family. It is a mixture-of-experts (MoE) model with 284B total parameters and 13B active parameters per token, a 1M-token context window, and a maximum output of 384K tokens.",
      paragraphs: [
        "Flash debuted on April 24, 2026 alongside the flagship V4 Pro. It is text-only, ships with MIT-licensed open weights, and is designed for high-volume, low-latency work. DeepSeek says Flash reasoning closely approaches V4 Pro, and Flash performs on par with V4 Pro on simple agent tasks.",
    ...
    },
    {
      ...
      description:
        "On July 31, 2026, DeepSeek moved the Flash API to official release (public beta) under build number DeepSeek-V4-Flash-0731. The key fact: this is not a new model. The official changelog states that 0731 keeps the same model architecture and size as DeepSeek-V4-Flash-Preview, and was only re-post-trained.",
      paragraphs: [
      ...
      list: [
        ...
        "Dedicated Codex integration support",
    ...
    },
    {
      ...
      description:
        "DeepSeek reports that Flash 0731 wins all nine published agent benchmarks against its own V4-Pro-Preview. The gains are most dramatic in software engineering, with DeepSWE jumping from 7.3 on the preview to 54.4 — roughly a 645% increase.",
      paragraphs: [
    ...
    },
    {
      ...
      description:
        "The 0731 release keeps the preview price. Input costs $0.14 per 1M tokens on a cache miss and output costs $0.28 per 1M tokens. Cached input is dramatically cheaper at $0.0028 per 1M tokens — roughly a 98% discount.",
      paragraphs: [
    ...
    },
    {
      ...
      description:
        "The 0731 weights ship with DSpark, DeepSeek's speculative decoding framework. Short for Confidence-Scheduled Speculative Decoding with Semi-Autoregressive Generation, DSpark was open-sourced under MIT on June 27, 2026 and is co-authored by DeepSeek founder Liang Wenfeng and a Peking University team.",
      paragraphs: [
