...
export const flashBenchmarks: GuideContent = {
  ...
  steps: [
    {
      ...
      description:
        "On July 31, 2026, DeepSeek pushed DeepSeek-V4-Flash-0731 to public beta on the official API. The changelog published a full agentic and coding benchmark table, and the budget model beat its own flagship V4-Pro-Preview on all nine published agent benchmarks. These are the headline deepseek v4 flash benchmark numbers for 2026.",
      paragraphs: [
        "The 0731 release is not a new model. DeepSeek states that DeepSeek-V4-Flash-0731 keeps the same model architecture and size as DeepSeek-V4-Flash-Preview: 284B total parameters with 13B active in a Mixture-of-Experts setup, and a 1M token context window. Only the post-training was redone. The upgrade applies to the Flash API only; the V4-Pro API and the APP/WEB models are unchanged.",
  ...
  "top_p": 0.95
    ...
    },
    {
      ...
      description:
        "Artificial Analysis ran its own evaluation on July 31, 2026, without DeepSeek's harness. The V4 Flash 0731 (Reasoning, Max Effort) scored an AA Intelligence Index of 50, 10 points above the April Flash and 6 points above V4 Pro at non-Max effort.",
      table: {
    ...
    },
    {
      ...
      description:
        "The 0731 benchmarks make Flash the default for high-volume agent work, but the scores are one input among several. Pair them with pricing, concurrency, and your workload before you pick.",
      list: [
