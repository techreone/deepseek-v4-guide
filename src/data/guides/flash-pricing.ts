...
export const flashPricing: GuideContent = {
  ...
  steps: [
    {
      ...
      paragraphs: [
        "DeepSeek's official pricing page is the source of truth, and it carries a standard caveat: \"Product prices may vary and DeepSeek reserves the right to adjust them.\" Third-party trackers re-verified these numbers against the official page on 2026-07-25 and 2026-07-29, and they match.[7]",
  ...
  -d '{
    ...
    },
    {
      ...
      note: "When combined with Flash routing and cache-friendly prompts, the three levers — route Flash, raise cache hits, stagger peak windows — typically cut bills 60-80%. If the API feels slow during peak hours, confirm it is the official system before blaming your config: https://status.deepseek.com",
    },
    {
      num: "07",
